...
public abstract class Stub {
	...
	//	System.out.println("in create xxxxxxxx");
		// throw new UnsupportedOperationException("not implemented");
		if (c == null || skeleton == null)
			throw new NullPointerException("Argument cannot be null!");

		if (!RMIhelper.isremoteinterface(c))
			throw new Error("Object does not implement a remote interface!");

		if (skeleton.getInetadr() == null || skeleton.getInetadr().getHostName() == null) {
			throw new IllegalStateException("skeleton has no address assigned");
		}
	//	System.out.println("after create   xxxxxxxx");
		InetSocketAddress serveradr = skeleton.getInetadr();

		if (serveradr == null)
			return null;
		//System.out.println("hererererererererere");
		return (T) Stub.newInstance(c, serveradr);
	...
	public static <T> T create(Class<T> c, InetSocketAddress address) {
		...
		return (T) Stub.newInstance(c, address);

	}

	/**
	 * function to create the proxy instance for the given skeleton This method
	 * will also the invocation handler for the proxy object
	 * 
	 * @param c
	 * @param serveradr
	 * @return
	...
	public static <T> Object newInstance(Class<T> c, InetSocketAddress serveradr) {
		/*
		 * return Proxy.newProxyInstance(c.getClassLoader(), new Class<?>[] { c
		 * }, new Stubhandler(c, serveradr));
		 */
		return Proxy.newProxyInstance(c.getClassLoader(), new Class<?>[] { c }, new Stubhandler(c, serveradr));
	}
